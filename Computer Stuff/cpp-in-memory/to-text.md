...
![[Pasted image 20240723105954.png]]
![MEMORY LAYOUT OF C++ OBJECT, virtual function works internally](https://web.archive.org/web/20200806192448im_/https://secureservercdn.net/160.153.137.218/bkh.972.myftpupload.com/wp-content/uploads/memory-layout-of-C-objects.png?time=1596737595)

Reading Time: 6 minutes

In this article, we will see the memory layout of different C++ Object. And how different storage & access specifiers affect this memory footprint. I am not going to discuss compiler augmented code, name mangling & working of any C++ mechanism related to memory as it is compiler & architecture-dependent. To keep this further simple, I have considered the standard [stack growth direction](https://web.archive.org/web/20200806192448/http://www.vishalchovatiya.com/how-c-program-convert-into-assembly/) i.e. downwards. And with the same, data members are represented inverted in memory(thanks to Thomas Vermeilh for pointing that out), that too I have ignored for simplicity. Although if you want to play around with the same, you can refer to this [link](https://web.archive.org/web/20200806192448/https://godbolt.org/z/NTZ5Z5).

So, in nutshell, it’s just all about **_“How different objects are laid out in memory?”_**

Contents

- [1 Memory Layout of Simple & Non-Polymorphic Object in C++](https://web.archive.org/web/20200806192448/https://vishalchovatiya.com/memory-layout-of-cpp-object/#Memory_Layout_of_Simple_Non-Polymorphic_Object_in_C)
- [2 Layout of an Object With Virtual Function & Static Data Member](https://web.archive.org/web/20200806192448/https://vishalchovatiya.com/memory-layout-of-cpp-object/#Layout_of_an_Object_With_Virtual_Function_Static_Data_Member)
- [3 Layout of C++ Object With Inheritance](https://web.archive.org/web/20200806192448/https://vishalchovatiya.com/memory-layout-of-cpp-object/#Layout_of_C_Object_With_Inheritance)
- [4 Memory Layout of an Object With Multiple Inheritances & Virtual Function](https://web.archive.org/web/20200806192448/https://vishalchovatiya.com/memory-layout-of-cpp-object/#Memory_Layout_of_an_Object_With_Multiple_Inheritances_Virtual_Function)
- [5 Layout of Object Having Virtual Inheritance](https://web.archive.org/web/20200806192448/https://vishalchovatiya.com/memory-layout-of-cpp-object/#Layout_of_Object_Having_Virtual_Inheritance)
...
- In addition, all other methods, constructor, destructor & [compiler augmented code](https://web.archive.org/web/20200806192448/http://www.vishalchovatiya.com/inside-the-cpp-object-model/) goes into the [text segment](https://web.archive.org/web/20200806192448/http://www.vishalchovatiya.com/how-c-program-stored-in-ram-memory/). These methods are then called & passed `this` pointer implicitly of calling object in its 1st argument which we have already discussed in [Inside The C++ Object Model](https://web.archive.org/web/20200806192448/http://www.vishalchovatiya.com/how-cpp-object-used-internally-in-the-executable/).
...
- Virtual table with all overridden virtual functions and code to assign `_vptr` with the virtual table is generated in the constructor of the class by the compiler. I have written more on this topic in the [virtual function series](https://web.archive.org/web/20200806192448/http://www.vishalchovatiya.com/part-1-all-about-virtual-keyword-in-cpp-how-virtual-function-works-internally/).
...
- You must be wondering why I have passed `y_ptr` as an argument here. It’s because of an implicit `this` pointer, you can learn about it [here](https://web.archive.org/web/20200806192448/http://www.vishalchovatiya.com/how-cpp-object-used-internally-in-the-executable/).
...
- However, shared region contains a virtual base class and it fluctuates with subsequent derivation & order of derivation. I have discussed more on this in [How Does Virtual Inheritance Works?](https://web.archive.org/web/20200806192448/http://www.vishalchovatiya.com/part-2-all-about-virtual-keyword-in-cpp-how-virtual-class-works-internally/).